...
const SuperAdminCondominiums = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setShowForm(false)
      setFormData({ name: '', address: '', totalUnits: '', totalBlocks: '', amenities: '', description: '' })
      fetchCondominiums()
    } catch (error) {
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-dark-blue">Condominium Management</h1>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <p className="text-2xl font-bold text-dark-blue">{condominiums.length}</p>
        </div>
        <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      {showForm && (
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <h2 className="text-xl font-semibold text-teal mb-4">Add New Condominium</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {condominiums.map((condo) => (
          <div key={condo.id} className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div className="bg-medium-green text-white rounded-full p-2">
                  <Building size={20} />
                </div>
                <h3 className="text-xl font-semibold text-dark-blue">{condo.name}</h3>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-dark-blue">{condo.totalUnits}</p>
                <p className="text-sm text-gray-600">Units</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-dark-blue">{condo.totalBlocks}</p>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div className="text-center">
                <div className="flex items-center justify-center space-x-1">
                  ...
                  <span className="text-lg font-semibold text-dark-blue">{condo.totalResidents}</span>
                </div>
              ...
              <div className="text-center">
                <div className="flex items-center justify-center space-x-1">
                  ...
                  <span className="text-lg font-semibold text-dark-blue">{condo.totalAdmins}</span>
                </div>
