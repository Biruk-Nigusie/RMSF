  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-teal">Here's what's happening in your community</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xl font-semibold text-teal">My Complaints</h3>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xl font-semibold text-teal">Announcements</h3>
            <FileText className="text-medium-green" size={24} />
          </div>
          <p className="text-2xl font-bold text-dark-blue">
            {dashboardData?.announcementsCount || 0}
          </p>
          <p className="text-gray-600">New announcements</p>
        </div>

        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xl font-semibold text-teal">Parking</h3>
            <Car className="text-medium-green" size={24} />
          </div>
          <p className="text-2xl font-bold text-dark-blue">
            {dashboardData?.parkingSlot || 'N/A'}
          </p>
          <p className="text-gray-600">Your parking slot</p>
        </div>

        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xl font-semibold text-teal">Utilities</h3>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xl font-semibold text-teal">Apartment</h3>
            <Home className="text-medium-green" size={24} />
          </div>
          <p className="text-2xl font-bold text-dark-blue">
            {user?.blockNumber}-{user?.apartmentNumber}
          </p>
          <p className="text-gray-600">Your unit</p>
        </div>

        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xl font-semibold text-teal">Balance</h3>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h3 className="text-xl font-semibold text-teal mb-4">Recent Activity</h3>
