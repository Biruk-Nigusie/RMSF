...
const Home = () => {
  ...
  const features = [
    {
      icon: <HousePlus size={32} />,
      title: "Condominium Management",
      description:
        "Complete management solution for Addis Ababa condominiums and apartments",
    },
    {
      icon: <HandCoins size={32} />,
      title: "Rent & Utility Collection",
      description:
        "Automated rent collection and utility bill management in ETB for Addis residents",
    },
    {
      icon: <Wrench size={32} />,
      title: "Maintenance Services",
      description:
        "Efficient handling of maintenance requests and repairs across Addis Ababa",
    },
    {
      icon: <NotebookText size={32} />,
      title: "Financial Reports",
      description:
        "Detailed financial insights and reporting tailored for Addis properties",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 lg:py-24">
          <div className="text-center">
            ...
            <p
              ...
              style={{ color: "white" }}
            >
              Residential Management System - Designed specifically for Addis
              Ababa condominiums and apartments. Streamline operations with
              local payment integration and Amharic support.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <button
                onClick={() => navigate("/register")}
                className="bg-blue-800 hover:bg-blue-800 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-sm cursor-pointer"
              >
                <p
            ...
            {/* Feature Showcase */}
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl shadow-sm p-8 max-w-4xl mx-auto border border-white/20">
              <div className="flex items-center justify-center mb-6">
                <div className="text-4xl mr-4" style={{ color: "white" }}>
      ...
      {/* Features Grid */}
      <section className="py-20 bg-white/10 from-blue-50 to-indigo-50">
        <div className="max-w-7xl mx-auto px-4" style={{ color: "#1C398E" }}>
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Why Choose AddisRMS?
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Comprehensive tools designed specifically for Addis Ababa
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-8 shadow-sm  transition-all duration-300 transform  border border-gray-100 text-center group"
              >
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-blue-900 mb-4">
              What Addis Residents Say
            </h2>
            <p className="text-xl text-gray-600">
              Trusted by property managers across Addis Ababa
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl lg:text-5xl font-bold mb-6">
                Serving All Addis Ababa Subcities
              </h2>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                From Bole to Akaki Kality, our platform supports property
                management across all 10 subcities of Addis Ababa with local
                expertise and community-focused solutions.
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              ...
              <p className="text-blue-100 text-center text-lg">
                Tailored specifically for Addis Ababa's unique residential
                management needs
              </p>
            </div>
          </div>
      ...
      {/* CTA Section */}
      <section
        className="py-20 bg-gradient-to-br bg-blue-50 "
        style={{ color: "#1C398E" }}
      >
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">
            Ready to Transform Your Addis Property?
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of Addis Ababa property managers who trust AddisRMS
            with their business
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => navigate("/register")}
              className="bg-blue-900  px-8 py-4 rounded-xl font-semibold"
